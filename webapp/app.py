...
app = FastAPI(title="Aegis - AI Urban Response & Analysis")
...
def frame_generator(idx: int):
    ...
    while p.is_running:
        ...
        cv2.putText(frame, f"Aegis NODE {idx+1} | {timestamp}", (10, frame.shape[0] - 20),
...
async def websocket_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            # Latency from avg (must be computed before performance uses it)
